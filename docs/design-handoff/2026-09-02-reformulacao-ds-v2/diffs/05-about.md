...
- [ ] **AB-01** — texto do `h1`. **Mock:** *I am a cyborg.* **Site:** *Letter to a unknown friend* — que é exatamente o texto da pílula âmbar logo acima (e com `a unknown` no lugar de `an unknown`). O mock usa a pílula como rótulo e o `h1` como afirmação. · `src/messages/en.json`
