...
**Subhead:** I take over platforms that have eroded to the point where no one can safely change them, and turn them into a delivery operation that runs on one meeting a month.
