...
description: A public digital garden of 3,312 engineering notes with an explicit
  publication gate, published through a customized Quartz build and distilled
  into Anki decks by a Python pipeline.
...
O Codex Technomanticus é o meu grimório: um jardim digital público com **3.312 notas** de engenharia de software, escritas em markdown, versionadas em git e publicadas como site. Não é um blog nem uma pasta de anotações — é uma base de conhecimento com arquitetura de informação, taxonomia tipada e portão de publicação explícito.
...
Autor único das três peças públicas: o conteúdo, a plataforma que o publica e o pipeline que o transforma em material de estudo.
...
## 7. Fluxo de trabalho com agentes
