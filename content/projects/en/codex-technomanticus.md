...
The Codex Technomanticus is my grimoire: a public digital garden of **3,312 software engineering notes**, written in Markdown, versioned in git and published as a site. It is not a blog and not a folder of jottings — it is a knowledge base with a designed information architecture, a typed taxonomy and an explicit publication gate.
...
Sole author of the three public pieces: the content, the platform that publishes it, and the pipeline that turns it into study material.
