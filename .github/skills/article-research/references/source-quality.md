# Qualidade de fontes (heurística rápida)

Use isto como guia para não “parecer IA” por falta de substância: a substância vem de fonte boa + exemplo concreto + delimitação.
...
## Sinais de fonte fraca

- Não explica contexto nem limitações
- Apresenta regra universal sem “quando não”
- Usa números sem metodologia
